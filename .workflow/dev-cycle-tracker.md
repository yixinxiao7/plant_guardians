...
| T-020 | User testing: All 3 MVP flows (novice, AI advice, inventory management) | Spike | User Agent | Backlog | P0 | M | 6 | — | All three user flows from project brief tested in browser; feedback logged to feedback-log.md. **Carried over from Sprints 1–5. Staging Deploy Verified: Yes (T-030). No blockers. Must complete Sprint 6 — no further carry-over permitted.** |
...
| T-027 | Update SPEC-004 to document redirect-to-detail behavior post-save (FB-005) | Documentation | Design Agent | Backlog | P3 | S | 6 | — | Amend SPEC-004 in ui-spec.md to reflect accepted behavior: after saving Edit Plant, app redirects to /plants/:id (not /). Add rationale note. Mark Approved with today's date. **Carried over from Sprints 4–5 — no work started. Must complete Sprint 6.** |
