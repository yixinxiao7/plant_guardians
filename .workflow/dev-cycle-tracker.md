...
| T-025 | Configure real Gemini API key + verify AI advice happy path end-to-end | Feature | Backend Engineer | Backlog | P1 | S | 4 | T-024 | Set GEMINI_API_KEY in backend/.env; test POST /ai/advice with photo and plant-type inputs; verify successful JSON response; update qa-build-log.md with happy-path test results. |
